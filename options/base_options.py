...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--nz', type=int, default=8, help='#Latent vector information bits')
        ...
        parser.add_argument('--model', type=str, default='divco2', help='chooses which model to use. bicycle,, ...')
